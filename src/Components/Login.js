                    ...
                    <form onSubmit={handleLogin} className="w-full p-8 lg:w-1/2">
                        ...
                        <div className="mt-4">
                            <div className="flex justify-between">
                                ...
                                <button type='button' onClick={handleResetPassword} className="text-xs text-gray-500 underline">Forget Password?</button>
                            </div>
                        ...
                        <div className="mt-4 flex items-center justify-between">
                            ...
                            <p className="text-xs text-gray-500 uppercase">or <Link to={'/register'} className="underline">sign up</Link></p>
                            <span className="border-b w-1/5 md:w-1/4"></span>
                        </div>
